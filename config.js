...
const namePrefix = "CharlieBots";
const description = "CharlieBots Insiders";
...
const layerConfigurations = [
  {
    ...
    layersOrder: [
      ...
      { name: "ear transparent" },
      { name: "eyes transparent" },
      { name: "head transparent" },
      { name: "mouth transparent" },
      { name: "shirt transparent" },
      { name: "special image transparent" },
    ],
  },
];
